...
from pytorch_grad_cam import GradCAM, GradCAMPlusPlus, ScoreCAM, XGradCAM, FullGrad, AblationCAM, LayerCAM, ShapleyCAM
...
def get_cam_comparative(model, image_tensor, method):
    ...
    match method:
        ...
        case 'fullgrad':
            ...
            target_layers = [module for name, module in model.named_modules() 
    ...
    cam = method_func(model, target_layers=target_layers)
